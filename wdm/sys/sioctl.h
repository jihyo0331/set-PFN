...
#define IOCTL_SET_PID \
    CTL_CODE( SIOCTL_TYPE, 0x910, METHOD_BUFFERED, FILE_ANY_ACCESS  )

#define IOCTL_SET_VA \
    CTL_CODE( SIOCTL_TYPE, 0x911, METHOD_BUFFERED, FILE_ANY_ACCESS  )

#define IOCTL_SET_PFN \
    CTL_CODE( SIOCTL_TYPE, 0x912, METHOD_BUFFERED, FILE_ANY_ACCESS  )
